                ...
                <div id="main" class="tabcontentWork">
                    <div class="reservation-container">
                        ...
                        if (isset($_SESSION['role']) && $_SESSION['role'] === 'guest') {
                            echo "<h1>Een gast kan geen reserveringen maken, login of registreer.</h1>";
                        }
                        if (isset($_SESSION['role']) && ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'user')) {
                            // Toon het reserveringsformulier en de reserveringstabel als de rol 'admin' of 'user' is
                            ?>
                        ...
                        <?php } else {
                            echo "<p>Inloggen vereist voor toegang tot reserveringen.</p>";
                        }
                        ?>
                                                    ...
                                                    <?php foreach ($category['items'] as $item): ?>
                                                        <div class="item">
                                                            <div class="item-details">
                                                                <p>
                                                                    Product:<strong><?php echo $item['name']; ?></strong>
                                                                </p>
                                                                <p>Prijs:
